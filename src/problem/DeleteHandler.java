...
public class DeleteHandler implements IDirectoryEventHandler {
	
	private Path file;
	private HashMap<String,String> map = new HashMap<String,String>();
	
	public DeleteHandler(Path file){
		this.file = file;

		System.out.println("initialize handler of type Delete");
	}
	
	public void registerType(String type, String command){
		System.out.println("DeleteHandler: Registering "+type+" type files with command "+command);
	...
	public void changeDirectory(Path dir) {
		this.file = dir;
		System.out.println("Delete Handler Change Directory to "+dir.toString());
	...
	public void removeType(String type) {
		...
		System.out.println("Remove handle function from DeleteHandler for type "+type);
	}
